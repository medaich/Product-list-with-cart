...
function ConfirmOrder() {
  ...
  return (
    <div>
      ...
      <h2 className="my-4 text-3xl font-bold">Order Confirmed</h2>
      <p className="mb-8 text-rose-500">We hope you enjoy your food!</p>

      <div className="rounded-lg bg-rose-100 p-4">
        <Cart cart={cart} confirmed={true} />
      ...
      <div className="flex justify-center">
        <button
          className="mt-6 rounded-full bg-custom-red px-16 py-3 font-semibold text-rose-50 hover:brightness-50"
          onClick={() => {
            reset();
          }}
        >
